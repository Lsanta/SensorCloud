...
function getQueryStringObject() {
      ...
      $.ajax({
            type : "POST",
            url : "http://183.106.6.74:8080/app/sitemain",
...
$("#sn").html(str);
    getData(sa);
      ...
      $.ajax({
        type : "POST",
        url : "http://183.106.6.74:8080/app/sitemainsensor",
  ...
  $.ajax({
    type : "POST",
    url : "http://183.106.6.74:8080/app/sitedata",
...
$.ajax({
            type : "POST",
            url : "http://183.106.6.74:8080/app/siterepairlist",
...
$(document).on("click", "#spanel" , function(){
    $.ajax({
    type : "POST",
    url : "http://183.106.6.74:8080/app/installsensor",

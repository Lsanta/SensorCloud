...
$(document).ready(function() {
	...
	$.ajax({
			...
			success : function(result7){
			 ...
			 $.ajax({
				type : "POST",
				url : "http://183.106.6.74:8080/app/mypage/mgetAttachListmypage",
				...
				success : function(arr){
					 ...
					 $(arr).each(function(i, attach){
							...
							if(attach.filetype){
								 ...
								 str += "<img class='delete1' src='http://183.106.6.74:8080/display?fileName="+fileCallPath+"'>";
								 str += "</div>";
								 str += "</li>";
		 ...
		 $.ajax({
				type : "POST",
				url : "http://183.106.6.74:8080/app/mypage/mypagemain",
	...
	$(document).ready(function() {
		 ...
		 function login() {
				...
				$.ajax({
					 type : "POST",
					 url : "http://183.106.6.74:8080/app/mypage/mypageconfirmpasswd.do",
					 ...
					 success : function(data) {
							...
							if (data == "success") {
								 alert("비밀번호 일치");
								//  window.location.href = "http://183.106.6.74:8080/app/mypage/usermodify";
	...
	$(document).ready(function() {
		 ...
		 $("#ok").click(function(){
				 ...
				 $.ajax({
					 ...
					 type : "POST",
					 url : "http://183.106.6.74:8080/app/mypage/levelup",
					 ...
					 success : function(data) {
							if(data == "success"){
								 ...
								 $.ajax({
											 type : "POST",
											 url : "http://183.106.6.74:8080/app/send/message.do",
	...
	$(document).ready(function() {
		$("#logout").click(function(){ 
			if(confirm("로그아웃 하시겠습니까?")){
				...
				$.ajax({
					type : "POST",
					url : "http://183.106.6.74:8080/app/mypage/deleteappToken",
